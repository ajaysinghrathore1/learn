Assignment 1: 
Use any other open source model in place of OpenAI and do the summarization of the pdf document using langchain and the concept of RAG. use chromadb vector database for this
 https://github.com/ajaysinghrathore1/learn/blob/main/python/hcl_genai_work/summarized.ipynb
...
write a python program to find similar audio files to the one you upload. Store many audio files and compare the one you upload with the stored ones. Using torchaudio framework or any other appropriate framework
 https://github.com/ajaysinghrathore1/learn/blob/main/python/hcl_genai_work/Audio%20file%20similarity%20check.ipynb
...
https://github.com/ajaysinghrathore1/learn/blob/main/python/hcl_genai_work/voice_translator.py
...
https://github.com/ajaysinghrathore1/learn/blob/main/python/RAG_Agentic/summarize_or_classify.py
